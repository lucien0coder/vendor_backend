...
const BaseSchema = new Schema({
    belonger : { type:String, default:'' },      // 基本体，拥有者
    name : { type:String, default:'' },          // 基本体，名称
    local : { type:String, default:''},         // 基本体，位置
    photo : { type:String, default:'' },         // 基本体，大头贴
    desc : { type:String, default:'' },          // 基本体，简述
    likes : { type:String, default:'' },         // 基本体，对象被赞的集合
    comments : { type:String, default:'' },      // 基本体，对象收到的评论集合
    entityType : { type:String, default:'' },    // 基本体，对象类型
